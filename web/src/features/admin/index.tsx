  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 h-2.5 rounded-full bg-border/50 overflow-hidden">
        <div
          className="h-full rounded-full bg-gradient-to-r from-accent to-[#8b5cf6] transition-all duration-500"
          style={{ width: `${pct}%` }}
        />
      </div>
...
function UserRow({ user, onReset, resetting }: { user: AdminUser; onReset: (id: number) => void; resetting: boolean }) {
  ...
  return (
    <div className="flex items-center gap-3 py-3 border-b border-border/30 last:border-0">
      <div className="w-9 h-9 rounded-full bg-gradient-to-br from-accent/80 to-[#8b5cf6] flex items-center justify-center text-white text-xs font-bold shrink-0">
      ...
      <button
        ...
        className="w-7 h-7 rounded-lg bg-destructive/10 flex items-center justify-center text-destructive disabled:opacity-40 active:scale-90 transition-transform shrink-0"
      >
          ...
          {confirmResetAll ? (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="text-xs px-3 py-1.5 rounded-xl bg-destructive/20 text-destructive font-semibold active:scale-95 transition-transform disabled:opacity-50 flex items-center gap-1"
              >
            ...
            <button
              ...
              className="text-xs px-3 py-1.5 rounded-xl bg-destructive/10 text-destructive font-medium active:scale-95 transition-transform flex items-center gap-1.5"
            >
          ...
          <>
            <div className="grid grid-cols-2 gap-3">
              <StatCard
                ...
                gradient="from-accent/80 to-[#8b5cf6]"
              />
              <StatCard
