...
func TestHttpStatus(t *testing.T) {
	tests := []struct {
		...
		{domain.ErrCategoryProtected, http.StatusForbidden},
...
func TestUserMessage(t *testing.T) {
	tests := []struct {
		...
		{domain.ErrCategorySystemReadOnly, "this category cannot be modified"},
		{domain.ErrCategoryProtected, "this category cannot be modified"},
